...
if(window.innerWidth > 568 && Enabled == true){
    let project1Folder = dragElement(document.getElementById("project1Div"));
    console.log('inside moving function')
...
function pop() {
  ...
  var num = Math.floor(Math.random()*listOfAnswers.length);
  const specialChars = /[`!@#$%^&*()_+\-=\[\]{};':"\\|,.<>\/~]/;
  const question = prompt("Ask a question to receive a fortune", "Will I find love?");

    if(/^\d+$/.test(question) == true){
      alert('Please enter a valid question!')
      }
    if(specialChars.test(question) == true){
      alert('Please enter a valid question!')
    }
    else{
      alert(listOfAnswers[num])
    }
    }
//-----------------------------------------------------------------------------------
    let project3Folder = dragElement(document.getElementById("project3Div"));
  ...
  //-----------------------------------------------------------------------------------
  let project4Folder = dragElement(document.getElementById("project4Div"));
